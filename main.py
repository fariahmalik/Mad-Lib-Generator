...
root = Tk()
root.title("Smart Programmer Mad Libs Generator")
...
Label(root, font=("Comic Sans MS", 16), text='Smart Programmer Mad Libs Generator').place(x=0, y=0)
...
ml3 = Button(root, text='The Ring', font=("Comic Sans MS", 16), command=lambda: third_madlib(root,photo), bg='LightSkyBlue')
